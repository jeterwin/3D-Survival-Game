...
namespace CollisionBear.WorldEditor
{
    ...
    public class PaletteEditor : Editor
    {
        ...
        private static readonly GUIContent UsePrefabHeightContent = new GUIContent("Use Prefab height", "If set, when placing an object, the prefabs set height (position's Y value) will be taken into consideration. This is also adjusted by the item's scale.\n If not, it's completely ignored.");
