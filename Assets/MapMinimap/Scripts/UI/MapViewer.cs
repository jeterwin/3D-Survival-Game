...
namespace MapMinimap
{
    ...
    public class MapViewer : MonoBehaviour
    {
        ...
        private void RefreshHoverDesc()
        {
            ...
            bool has_fog = settings && settings.fog;
        ...
        {
            MapReveal player = MapReveal.GetPlayer(MapManager.Get().reveal_id);
        ...
        public float GetPixelScale()
        {
            ...
            {
                float min_scale = panel_size.y / map_render_size.y;
                float max_scale = min_scale * settings.zoom_max;
        ...
        public float GetFactorScale()
        {
            MapSettingsData settings = MapSettingsData.Get();
            if (settings != null)
                return current_zoom * (settings.zoom_max-1f) + 1f;
            return 1f;
        }
